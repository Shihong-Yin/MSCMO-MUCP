...
% The multi-objective cooperative path planning of multiple USVs
    ...
    methods
        ...
        function Setting(obj)
            % Parameter setting
            obj.USV.num = 5; % USV的数量
            obj.USV.vel = [10 12;9 13;11 13;10 13;8 11]; % USV的航行速度范围
            obj.USV.startPos = [0 95;5 100;5 95;5 90;10 95]; % 起始点
            obj.USV.goalPos = [100 5;95 0;95 5;95 10;90 5]; % 目标点
        ...
        function R = GetOptimum(obj,~)
            R = [1000, 62, 40]; % 参考点先不考虑，这个点可以用来计算HV
        end
    end
end
