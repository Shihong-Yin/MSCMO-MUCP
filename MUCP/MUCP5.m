...
% The multi-objective cooperative path planning of multiple USVs
    ...
    methods
        ...
        function Setting(obj)
            % Parameter setting
            obj.USV.num = 4; % USV的数量
            obj.USV.vel = [10 12;9 13;11 13;8 11]; % USV的航行速度范围
            obj.USV.startPos = [0 0;0 100;100 100;100 0]; % 起始点
            obj.USV.goalPos = [55 55;55 45;45 45;45 55]; % 目标点
        ...
        function R = GetOptimum(obj,~)
            R = [389, 46, 23]; % 参考点先不考虑，这个点可以用来计算HV
        end
    end
end
