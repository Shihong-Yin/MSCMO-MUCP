...
% The multi-objective cooperative path planning of multiple USVs
    ...
    methods
        ...
        function Setting(obj)
            % Parameter setting
            obj.USV.num = 3; % USV的数量
            obj.USV.vel = [10 12;9 13;11 13]; % USV的航行速度范围
            obj.USV.startPos = [0 95;5 100;5 95]; % 起始点
            obj.USV.goalPos = [100 5;95 0;95 5]; % 目标点
        ...
        function R = GetOptimum(obj,~)
            R = [528, 61, 25]; % 参考点先不考虑，这个点可以用来计算HV
        end
    end
end
