...
% The multi-objective cooperative path planning of multiple USVs
    ...
    methods
        ...
        function Setting(obj)
            % Parameter setting
            obj.USV.num = 9; % USV的数量
            obj.USV.vel = [10 12;9 13;11 13;10 13;8 11;10 12;9 13;11 13;8 11]; % USV的航行速度范围
            obj.USV.startPos = [100 50;88.30 82.14;58.68 99.24;25 93.30;3.02 67.10;3.02 32.90;25 6.70;58.68 0.76;88.30 17.86]; % 起始点
            obj.USV.goalPos = [0 50;11.70 17.86;41.32 0.76;75 6.70;96.98 32.90;96.98 67.10;75 93.30;41.32 99.24;11.70 82.14]; % 目标点
            ...
            for i = 1:obj.USV.num
                ...
                lower = [lower, 0.9*ones(1,Nodes), -r*scale];
                upper = [upper, ones(1,Nodes), r*scale];
                encoding = [encoding, 1+zeros(1,Nodes), 1+zeros(1,Nodes)];
            end
            obj.lower    = lower;
            obj.upper    = upper;
        ...
        function Population = Evaluation(obj,varargin)
            ...
            parfor m = 1:size(Pop, 1)
                ...
                for k = 1:USV_num
                    ...
                    smoothCost = sum(turn_angles); % 将弧度转换为角度
        ...
        function R = GetOptimum(obj,~)
            R = [1253, 139, 53]; % 参考点先不考虑，这个点可以用来计算HV
        end
    end
end
...
%     y1 = interp1(Xo,Yo,x1,'linear');  z1 = interp1(Xo,Zo,x1,'linear'); % 路径插值
    ...
    Trans = [1 0 0 -startPos(i,1); 0 1 0 -startPos(i,2); 0 0 1 0; 0 0 0 1];
...
%     PathO = Homo \ [Xh; Yh; Zh; ones(1,size(Xh,2))];
    PathM = Homo \ [xh; yh; zeros(1,Density); ones(1, Density)];
